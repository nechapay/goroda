  ...
  data() {
    return {
      places: {
        ...
        place25: {
          description:
            'ойны между Россией (Московским государством) и этим государством второй половине 16 – третьей четверти 17 в. велись за обладание западно-русскими землями. Эта страна Восточной Европы, на севере омывается Балтийским морем. Краковяк – народный танец этой страны.',
          src: './img/25.png',
          title: 'Польша'
        }
      },
